    ...
    if(sessionStorage.sleepCount==null||sessionStorage.goalCount==null){
        ...
        var timeStart = new Date("2019-03-11 "+sessionStorage.index_bedtime).getTime();
          ...
          if(no_hrs>7.5||no_hrs==7.5){
            ...
            "<div style='float:left;margin:41% 10px 0 -400px;width:210px;border:1px solid black;border-radius:7%;padding:10px;'>"+
            "<h3>Average Hours of Sleep:</h3>7.5 hours</div>"+
            "<div style='float:left;margin: 41% 50px 0 -150px;width:150px;border:1px solid black;border-radius:7%;padding:10px;'>"+
...
function next_stats(){
  ...
  "<div style='float:left;margin-left:40px;'><h3>Waketime Stats</h3>"+
